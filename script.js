...
function choseCountry(country) {
    if(country === 'japan'){
        makeAnswer(Object.keys(japanese).length);
    } else if (country === 'USA'){
        makeAnswer(Object.keys(american).length);
    } else if (country === 'german') {
        makeAnswer(Object.keys(germany).length);
    } else if (country === 'china') {
        makeAnswer(Object.keys(chinese).length);
    } else if (country === 'indonesia') {
        makeAnswer(Object.keys(indonesian).length);
    }
}
